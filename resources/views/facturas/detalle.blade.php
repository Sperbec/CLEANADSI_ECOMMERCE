    ...
    <div class=" table-responsive">
		...
		<div class="section">
					...
					<div class="col-md-7">
						...
						<div class="shiping-details">
							<div class="section-title">
								<h3 class="title">Formulario Factura</h3>
							</div>
							<div class="input-checkbox">
								...
								<div class="Opcion Entrega">
                                    ...
                                    <select name="opcion_entregas" id="opcion_entregas" class="form-select">
                                     <option value=''>Seleccione Metodo de Envio</option>
                                        @foreach ($opcion_entregas as $opcion_entrega)
                                            <option value="{{ $opcion_entrega->id_opcion }}">{{ $opcion_entrega->nombre }}</option>
                                        @endforeach
                                      </select>
									</div>
									<div class="form-group">
                                    <select name="opcion_pagos" id="opcion_pagos" class="form-select">
                                     <option value=''>Seleccione Tipo de Pago</option>
                                        @foreach ($opcion_pagos as $opcion_pago)
                                            <option value="{{ $opcion_pago->id_opcion }}">{{ $opcion_pago->nombre }}</option>
                                        @endforeach
                                      </select>
									</div>
									<!-- <div class="form-group">
			...
			<!-- /container -->
                        ...
                        <button class=" text-center col-md-2 primary-btn order-submit" type="submit"> Ir a pagar</button>
