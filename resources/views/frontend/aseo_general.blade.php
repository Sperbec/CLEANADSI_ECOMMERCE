    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="aside" class="col-md-3">
                <!-- aside Widget -->
                <div class="aside">
                    <h3 class="aside-title">Aseo General</h3>
                    ...
                    <div class="col-md-4 col-xs-6">
                        ...
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-name"><a href="#">{{$pag->nombre}}</a></h3>
                                <h4 class="product-price">${{$pag->precio}} <del class="product-old-price">$990.00</del></h4>
