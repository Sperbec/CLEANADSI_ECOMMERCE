...
<html lang="en">
<head>
  <title>Factura {{$encabezado->codigo}}</title>
  <meta charset="utf-8">
...
<body>
    ...
    <div class="row text-center" style="margin-bottom: 2rem;">
        ...
        <div class="col-xs-6">
            <h2>Factura de venta - {{$encabezado->codigo}}</h2>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <label class="negrita">Facturado a: </label>
        <label>{{$encabezado->nombrecompleto}}</label>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <label class="negrita">Costo de envío: </label>
        <label>${{$encabezado->costo_envio}}</label>
    </div>
    <div class="col-md-6">
...
<table class="table table-hover" id="tblDetalleFactura">
    <thead>
        <tr>
            ...
            <td class="negrita text-right">Precio unitario</td>
            <td class="negrita text-right">Subtotal</td>
        </tr>
    </thead>
    <tbody>
        ...
        @endforeach
        <tr>
            <td colspan="4"  class="negrita text-right">Subtotal</td>
            <td class="negrita text-right">${{$encabezado->subtotal}}</td>
        </tr>

        <tr>
            <td colspan="4"  class="negrita text-right">IVA</td>
