...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <label for="cod_recuperacion" class="text">Código de recuperación:</label>
    ...
    <div class="row">
        ...
        <div class="col-6 col-md-8">
            <input type="submit" value="Enviar mi contraseña" style="margin-top: 20px;" class="btn btn-block btn-primary">
        </div>
    </div>
