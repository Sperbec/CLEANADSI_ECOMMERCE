                ...
                <td>
                    <div class="row">
                        <a id="btnEditar" data-toggle="modal"
                            data-target="#mdlEditarPais{{ $pais->id_pais }}" class="btn btn-primary opts"
                            data-toggle="tooltip" data-bs-placement="top" title="Editar país">
                            <i class="fas fa-edit"></i></a>

                        <form class="formEliminar"
                            action="{{ route('pais.destroy', $pais->id_pais) }}" method="post">
                            @csrf
                            @method('DELETE')
